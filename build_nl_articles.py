...
ARTICLES = {
    ...
    "ai-agent-kopen": {
        ...
        "body": """
            ...
            <p>Ik heb 23 jaar in de bankenwereld gezeten en kan niet klassiek programmeren. Mijn route: ik beschrijf in gewone taal aan een AI-codeerassistent (Claude Code, of de agent van Replit) wat ik wil, plak de gegenereerde code in de terminal van mijn VPS, en test. Stap voor stap groeit dat uit tot een agent die zelfstandig draait. De bouwstenen: een <a href="https://aibuildermarketplace.com/b2b/hostinger-review/" target="_blank">VPS</a> (een paar euro per maand), een AI-assistent om mee te bouwen, en geduld. Mijn complete setup beschrijf ik in <a href="ai-p-seo.html">het artikel over mijn content-machine</a>.</p>
            <div class="crosslink-box">
                <h3>The Edge Perspective</h3>
    ...
    "ai-p-seo": {
        ...
        "body": """
            ...
            <ul>
                <li><strong>Een VPS als thuisbasis.</strong> Alles draait op <a href="https://aibuildermarketplace.com/b2b/hostinger-review/" target="_blank">een Hostinger VPS</a>: mijn agent Victor, de generators, de geplande taken. Geen laptop die aan moet staan, geen afhankelijkheid van mijn aanwezigheid.</li>
